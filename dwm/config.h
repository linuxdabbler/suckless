...
static const char *exitcmd[]  = { "ld-exit", NULL };
static const char *sidebarcmd[] = { "sidebarmenu.sh", NULL };
static const char *editconfigs[] = { "edit-configs.sh", NULL };
static Key keys[] = {
	/* modifier                     key                 function           argument */
    { ALTMOD,                       XK_b,               spawn,              SHCMD("wal") },
    { ALTMOD,                       XK_p,               spawn,              SHCMD("bmenu") },
    { ALTMOD,                       XK_F12,             spawn,              SHCMD("/opt/piavpn/bin/pia-client") },
...
/*	{ MODKEY,                       XK_Tab,             view,               {0} },    */
    ...
    { MODKEY,                       XK_o,               setlayout,          {.v = &layouts[4]} }, /* centered floating master layout */
...
static Button buttons[] = {
	...
	{ ClkButton,	    	0,      		Button1,    	spawn,		    {.v = sidebarcmd } },
    { ClkButton,            0,              Button3,        spawn,          {.v = editconfigs} },
